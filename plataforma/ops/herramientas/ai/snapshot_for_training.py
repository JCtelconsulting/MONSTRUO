...
CTX_FILE = os.path.join(PROJECT_ROOT, "plataforma/docs/PROYECTO_CONTEXTO.md")
UNIVERSAL_PROMPT_FILE = os.path.join(PROJECT_ROOT, "plataforma/docs/PROMPT_CHAT_UNIVERSAL.md")
