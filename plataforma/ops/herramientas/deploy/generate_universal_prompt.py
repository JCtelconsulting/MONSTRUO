...
CTX_FILE = PROJECT_ROOT / "plataforma" / "docs" / "PROYECTO_CONTEXTO.md"
OUT_FILE = PROJECT_ROOT / "plataforma" / "docs" / "PROMPT_CHAT_UNIVERSAL.md"
...
```bash
python3 plataforma/ops/herramientas/deploy/verify_structure.py --root {project_root}
```
"""
