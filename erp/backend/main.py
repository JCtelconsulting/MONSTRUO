...
from erp.backend import router as erp_router
from plataforma.core import deps
from plataforma.core.web import build_login_redirect_url

app = FastAPI(title="Monstruo - ERP API", version="1.0")

ui_dir = repo_root / "erp" / "ui"
app.mount("/static", StaticFiles(directory=str(ui_dir)), name="erp_static")
