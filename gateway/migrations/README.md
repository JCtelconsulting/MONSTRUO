...
Archivos SQL versionados para el schema `gateway` en PostgreSQL.
...
```bash
docker exec -i monstruo-dev-db psql -U monstruo -d monstruo_dev < gateway/migrations/NNN_nombre.sql
```
