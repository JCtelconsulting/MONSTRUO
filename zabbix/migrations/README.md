...
Archivos SQL versionados para el schema `zabbix` en PostgreSQL.
...
```bash
docker exec -i monstruo-dev-db psql -U monstruo -d monstruo_dev < zabbix/migrations/NNN_nombre.sql
```
