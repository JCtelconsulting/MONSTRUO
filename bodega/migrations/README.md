...
Archivos SQL versionados para el schema `bodega` en PostgreSQL.
...
```bash
docker exec -i monstruo-dev-db psql -U monstruo -d monstruo_dev < bodega/migrations/NNN_nombre.sql
```
