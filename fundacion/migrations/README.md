# Fundacion — Migraciones

Archivos SQL versionados para el schema `fundacion` en PostgreSQL.
...
```bash
docker exec -i monstruo-dev-db psql -U monstruo -d monstruo_dev < fundacion/migrations/NNN_nombre.sql
```
