...
SELECT
    ...
    sd.fecha,
    sbm.product_id,
    -- Separación: sin catálogo de bodega (Monstruo). El material es el texto libre;
    -- product_id queda como referencia histórica numérica sin resolver nombre/sku.
    sbm.nombre_libre                                    AS material,
    NULL::text                                          AS sku,
...
GROUP BY sd.sede_id, s.code, s.nombre, sd.fecha, sbm.product_id, sbm.nombre_libre;
