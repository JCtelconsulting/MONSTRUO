...
import router as crm_router
from plataforma.core import deps
from plataforma.core.web import build_login_redirect_url

app = FastAPI(title="Monstruo - CRM API", version="1.0")

# Servir estáticos propios del módulo
ui_dir = Path(__file__).parent / "ui"
app.mount("/static", StaticFiles(directory=str(ui_dir)), name="tks_static")
