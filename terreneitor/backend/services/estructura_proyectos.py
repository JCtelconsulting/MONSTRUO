...
STRUCTURE_TEMPLATES = {
    ...
    "INTERPOSTE": [
        "INTERPOSTE/PREVIO/1.01 INSPECCION Y REPLANTEO DEL PUNTO",
        "INTERPOSTE/PREVIO/1.02 ESTADO INICIAL DEL TERRENO",
        "INTERPOSTE/EXCAVACION/2.01 EXCAVACION (PROFUNDIDAD Y DIMENSIONES)",
        "INTERPOSTE/HORMIGON/3.01 HORMIGONADO DE FUNDACION",
        "INTERPOSTE/HORMIGON/3.02 POSTE EMPLAZADO EN HORMIGON",
        "INTERPOSTE/CONEXIONES/4.01 CONEXIONES Y CANALIZACION",
        "INTERPOSTE/APLOMADO/5.01 APLOMADO Y VERTICALIDAD DEL POSTE",
        "INTERPOSTE/TERMINACIONES/6.01 TERMINACIONES Y SELLOS",
        "INTERPOSTE/TERMINACIONES/6.02 FOTO FINAL DEL POSTE",
    ],
}
...
SAFE_TEMPLATES = {"PMC", "OBRA", "SATLINK", "DOMICILIO", "LEVANTAMIENTO", "INTERPOSTE"}
