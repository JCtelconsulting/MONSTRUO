...
STRUCTURE_TEMPLATES = {
    "PMC": [
        ...
        # Interposte como grupo propio dentro de todo PMC (acordeón "Interposte" con sus fases).
        "INTERPOSTE/INTERPOSTE/Previo",
        "INTERPOSTE/INTERPOSTE/Excavación",
        "INTERPOSTE/INTERPOSTE/Hormigón",
        "INTERPOSTE/INTERPOSTE/Conexiones",
        "INTERPOSTE/INTERPOSTE/Aplomado",
        "INTERPOSTE/INTERPOSTE/Terminaciones",
    ],
    "SATLINK": [
    ...
    # Interposte: UNA sola categoría "INTERPOSTE" con sus fases como tareas, para que
    # en el planificador salga como un único acordeón "Interposte" y al abrirlo las fases.
    "INTERPOSTE": [
        "INTERPOSTE/INTERPOSTE/Previo",
        "INTERPOSTE/INTERPOSTE/Excavación",
        "INTERPOSTE/INTERPOSTE/Hormigón",
